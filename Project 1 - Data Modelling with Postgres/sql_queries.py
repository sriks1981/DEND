...
# CREATE TABLES
songplay_table_create = ("""create table if not exists songplays(songplay_id serial PRIMARY KEY, start_time timestamp NOT NULL, user_id int NOT NULL, level varchar NOT NULL, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar)
""")
...
time_table_create = ("""create table if not exists time(time_id serial PRIMARY KEY, start_time timestamp, hour int, day int, week int, month int, year int, weekday int)
""")
